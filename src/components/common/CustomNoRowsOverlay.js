...
// import NoRowsImage from "./path/to/your/image.png"; // Replace with the path to your image

const CustomNoRowsOverlay = () => {
  return (
    <GridOverlay>
      <div style={{ textAlign: "center", padding: "20px" }}>
        {/* <img src={NoRowsImage} alt="No rows" style={{ maxWidth: '100%', height: 'auto' }} /> */}
        <svg
        ...
        <div style={{ marginTop: '10px', fontSize: '14px', color: '#919EAB',fontWeight: 600, }}>
          No data
        </div>
      </div>
    </GridOverlay>
