...
import solarEnergy from '../assets/Icons/solar-energy.png';
import sunEnergy from '../assets/Icons/sun-energy.png';
import location from '../assets/Icons/location.png';
import roleManger from '../assets/Icons/profile (4).png';
import {
  Users,
  Settings,
  LogOut,
...
const ProjectSite_SidebarDisabled = () => {
            ...
            <Collapse in={isCollapse1} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                  ...
                  <ListItemButton sx={{ pl: 2 }} disabled>
                    ...
                    <ListItemText
                      primary={
                        <Typography variant="body1" sx={{ fontWeight: 500 }} disabled>
                          Home
                        </Typography>
                      } />
                  </ListItemButton>
...
export default ProjectSite_SidebarDisabled