    ...
    <>
      {showImageCard && filterdata ? (
        <div className="cardDetail ">
          <img src="/fuel.png" alt="Battery"  style={{ width: '30px', height: '30px' }}/>
          <h6 style={{ fontWeight: "bold" }}>Fuel_cell</h6>
          {filterdata?.live_schematic?.Fuel_cell ? (
            <div>
              {Object.entries(filterdata.live_schematic.Fuel_cell)
