    ...
    <>
      {showImageCard && filterdata ? (
        <div className="cardDetail ">
          <img src="/wind.png" alt="Battery"  style={{ width: '30px', height: '30px' }}/>
          <h6 style={{ fontWeight: "bold" }}>Wind_plant</h6>
          {filterdata?.live_schematic?.Wind_plant ? (
            <div>
              {Object.entries(filterdata.live_schematic.Wind_plant)
